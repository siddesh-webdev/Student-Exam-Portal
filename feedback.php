  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/1.jpg" width=100 height=100 alt="Siddesh Pradeep Bhosale" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Siddesh Bhosale</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 917709231184</h4>
		<h4 style="font-family:'typo' ">siddeshpbhosale259@gmail.com</h4>
		<h4 style="font-family:'typo' ">NMITD,Dadar</h4></div></div>
		</p>
      </div>
