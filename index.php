...
<title>University Examination </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">University Examination</span></div>
  ...
  <div class="col-md-6">
    <input id="password" name="password" placeholder="Enter your Password" class="form-control input-md" type="password">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="btnsub">Sign in</button>
		</fieldset>
</form>
      </div>
    </div><!-- /.modal-content -->
...
<a href="#" data-toggle="modal" data-target="#login">Admin Login</a> <a href="feedback.php" target="_blank">Feedback</a></div></div>
